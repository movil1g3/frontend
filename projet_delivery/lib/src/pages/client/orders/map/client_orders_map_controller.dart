...
class ClientOrdersMapController extends GetxController {
  ...
  void updateLocation() async {
    try{
      ...
      animateCameraPosition(order.lat ?? 14.6562046,  order.lng ?? -86.2511316);

      addMarker(
          'delivery',
          order.lat ?? 14.6562046,
          order.lng ?? -86.2511316,
          'Tu repartidor',
          '',
          deliveryMarker!
      );
      ...
      LatLng from = LatLng(order.lat ?? 14.6562046, order.lng ?? -86.2511316);
